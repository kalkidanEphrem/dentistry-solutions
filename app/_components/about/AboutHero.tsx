  ...
  return (
    <section className="bg-tertiary relative flex flex-col-reverse xl:flex-row 2xl:px-24 xl:px-16 md:px-12 sm:px-6 p-2 overflow-clip">
      ...
      <div className="xl:w-2/5 p-5 z-10">
        <div className="bg-white px-10 pb-8 xl:pb-4 pt-6 xl:px-16 max-w-sm rounded-xl relative left-4 sm:left-5 lg:left-4 xl:-left-1/4 shadow-lg xl:mt-6">
        ...
        <div className="flex xl:flex-col flex-wrap justify-around items-center gap-16 mt-14 xl:mt-16">
          ...
          <Link
            href="/"
            className="py-3 px-9 rounded-md sm:mt-6 font-semibold text-center max-w-min bg-primary text-white hover:cursor-pointer animate-bounce shadow-md"
          >
