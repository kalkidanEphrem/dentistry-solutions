  ...
  return (
    <section className="w-full xl:px-28 md:px-20 px-10 pt-16">
      ...
      <div className="grid xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-1 gap-4 xl:gap-6 2xl:gap-28 mt-10 pb-5 pt-10">
        {/* 1st card */}
        <div className="flex flex-col max-w-sm border-r-2 shadow-sm border-b-2 p-4 rounded-lg md:col-span-2 xl:col-span-1 hover:scale-105">
          <Link href="/">
            {/* 1st card icon */}
            <svg
              width="70"
        ...
        {/* 2nd card */}
        <div className="flex flex-col max-w-sm p-4 xl:border-hidden border-r-2 shadow-sm border-b-2 rounded-lg md:col-span-2 lg:col-start-2 xl:col-span-1 xl:shadow-xl order-2 xl:order-1 hover:scale-105">
          <Link href="/">
            {/* 2nd card icon */}
            <svg
              width="70"
        ...
        {/* 3rd card */}
        <div className="flex flex-col max-w-sm p-4 border-r-2 shadow-sm border-b-2 md:col-start-2 lg:col-start-3 rounded-lg order-1 hover:scale-105">
          <Link href="/">
            {/* 3rd card icon */}
            <svg
              width="70"
